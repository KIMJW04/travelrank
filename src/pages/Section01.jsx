...
const Card = ({ title, description, image, alt, onDetailClick }) => (
    <div className="city-card">
        ...
        <div className="city-info">
            <h2>{title}</h2>
            <p>{description}</p>
            <button className="detail_button" onClick={onDetailClick}>
                상세보기
            </button>
        </div>
    </div>
    ...
    return (
        <div className="carousel" ref={carouselRef}>
            <div className="cards-container">
                ...
                <button className="nav down" onClick={() => updateIndex(active + 1)}>
        ...
        <>
            ...
            <div className="cont">
                <div className="section_img">
                    {images.map((img, index) => (
                        <img key={index} src={img.image} alt={img.alt} className={img.visible ? "" : "hidden"} />
                    ))}
                </div>
